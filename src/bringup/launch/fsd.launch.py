...
def _run(package: str, executable: str, name: str, parameters=None):
    return Node(
        ...
        name=name,
        output='screen',
        condition=IfCondition(_arg('use_fsd_tail')),
...
def generate_launch_description():
    ...
    return LaunchDescription([
        ...
        DeclareLaunchArgument('use_fsd_tail', default_value='true'),
        ...
        # FSD perception/decision/control tail. The external base bringup owns
